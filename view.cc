...
void View::init() {
    ...
    _impl._commandkeys['H']               = &Game::keepMoving_left;
    _impl._commandkeys['J']               = &Game::keepMoving_down;
    _impl._commandkeys['K']               = &Game::keepMoving_up;
    _impl._commandkeys['L']               = &Game::keepMoving_right;
    _impl._commandkeys['Y']               = &Game::keepMoving_upleft;
    _impl._commandkeys['U']               = &Game::keepMoving_upright;
    _impl._commandkeys['B']               = &Game::keepMoving_downleft;
    _impl._commandkeys['N']               = &Game::keepMoving_downright;
    _impl._commandkeys['c']               = &Game::close;
    _impl._commandkeys['f']               = &Game::fight;
    _impl._commandkeys['F']               = &Game::keepFighting;
    _impl._commandkeys['m']               = &Game::moveover;
    _impl._commandkeys['M']               = &Game::keepMovingover;
